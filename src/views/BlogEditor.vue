    ...
    <div class="write-blog-container">
      ...
      <form @submit.prevent="submitBlog">
        ...
        <div class="form-group">
          ...
          <Editor :init="init" v-model="content" style="min-height: 600px;"></Editor>
...
import '@/assets/editor/WordPaster/js/json2.min.js'
import '@/assets/editor/WordPaster/js/jquery-1.8.3.min.js'
// import '../tinymce/plugins/WordPaster/js/w.edge.js'
// import '../tinymce/plugins/WordPaster/js/w.app.js'
import '@/assets/editor/WordPaster/js/w.file.js'
// import '../tinymce/plugins/WordPaster/js/skygqbox.js'
import '@/assets/editor/WordPaster/plugin/wordpaster.js'
    ...
    return {
      ...
      init: {
        ...
        external_plugins: {
          ...
          //  wordpaster: "../public/static/tinymce/plugins/wordpaster"
        },
        plugins:
